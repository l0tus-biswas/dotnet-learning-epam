...
namespace EMartWinForm {
    ...
    public partial class WordVoyagerDataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserRow AddUserRow(string Username, string Email, string PasswordHash, System.DateTime RegistrationDate) {
...
namespace EMartWinForm.WordVoyagerDataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[User] WHERE (([UserId] = @Original_UserId) AND ([Username] = @" +
                "Original_Username) AND ([Email] = @Original_Email) AND ([PasswordHash] = @Origin" +
                "al_PasswordHash) AND ([RegistrationDate] = @Original_RegistrationDate))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[User] ([Username], [Email], [PasswordHash], [RegistrationDate]" +
                ") VALUES (@Username, @Email, @PasswordHash, @RegistrationDate);\r\nSELECT UserId, " +
                "Username, Email, PasswordHash, RegistrationDate FROM [User] WHERE (UserId = SCOP" +
                "E_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [Username] = @Username, [Email] = @Email, [PasswordHash] = @PasswordHash, [RegistrationDate] = @RegistrationDate WHERE (([UserId] = @Original_UserId) AND ([Username] = @Original_Username) AND ([Email] = @Original_Email) AND ([PasswordHash] = @Original_PasswordHash) AND ([RegistrationDate] = @Original_RegistrationDate));
SELECT UserId, Username, Email, PasswordHash, RegistrationDate FROM [User] WHERE (UserId = @UserId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EMartWinForm.Properties.Settings.Default.WordVoyagerConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserId, Username, Email, PasswordHash, RegistrationDate FROM dbo.[User]";
        ...
        public virtual int Fill(WordVoyagerDataSet.UserDataTable dataTable) {
        ...
        public virtual WordVoyagerDataSet.UserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            WordVoyagerDataSet.UserDataTable dataTable = new WordVoyagerDataSet.UserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(WordVoyagerDataSet.UserDataTable dataTable) {
        ...
        public virtual int Delete(int Original_UserId, string Original_Username, string Original_Email, string Original_PasswordHash, System.DateTime Original_RegistrationDate) {
        ...
        public virtual int Insert(string Username, string Email, string PasswordHash, System.DateTime RegistrationDate) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Email, string PasswordHash, System.DateTime RegistrationDate, int Original_UserId, string Original_Username, string Original_Email, string Original_PasswordHash, System.DateTime Original_RegistrationDate, int UserId) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Email, string PasswordHash, System.DateTime RegistrationDate, int Original_UserId, string Original_Username, string Original_Email, string Original_PasswordHash, System.DateTime Original_RegistrationDate) {
            return this.Update(Username, Email, PasswordHash, RegistrationDate, Original_UserId, Original_Username, Original_Email, Original_PasswordHash, Original_RegistrationDate, Original_UserId);
        }
    }
