...
-- Inserting values into [Tag] table
...
-- Inserting values into [ArticleTag] table
...
-- Inserting values into [Attachment] table
INSERT INTO [Attachment] (AttachmentId, ArticleId, FileName, FileType, FilePath, UploadDate)
VALUES 
(1, 1, 'ai_image.jpg', 'Image', '/attachments/ai_image.jpg', '2024-01-31 16:30:00'),
(2, 3, 'europe_map.pdf', 'PDF', '/attachments/europe_map.pdf', '2024-01-31 16:45:00'),
(3, 4, 'healthy_eating_infographic.png', 'Image', '/attachments/healthy_eating_infographic.png', '2024-01-31 17:00:00'),
(4, 2, 'space_photo.jpg', 'Image', '/attachments/space_photo.jpg', '2024-01-31 17:15:00'),
(5, 5, 'literature_quotes.txt', 'Text', '/attachments/literature_quotes.txt', '2024-01-31 17:30:00');